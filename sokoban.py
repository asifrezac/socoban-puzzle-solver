...
class Warehouse:
    ...
    def extract_locations(self, lines):
        ...
        targets_with_boxes = list(
            find_2D_iterator(lines, "*"))  # box on target
...
if __name__ == "__main__":
    wh = Warehouse()
    wh.load_warehouse("/Users/asifrezachowdhury/Library/CloudStorage/OneDrive-Personal/Academics/QUT Academics/Semester 2-1/IFN680 AIML/Assignments/Assignment 1/Assignment1/warehouses/warehouse_01.txt")
